...
// Panel configuration for tech infrastructure analysis
export const DEFAULT_PANELS: Record<string, PanelConfig> = {
  map: { name: 'Global Infrastructure Map', enabled: true, priority: 1 },
  // Core Infrastructure
  security: { name: 'Cyber Attacks', enabled: true, priority: 1 },
  outages: { name: 'Internet Outages', enabled: true, priority: 1 },
  cables: { name: 'Undersea Cables', enabled: true, priority: 1 }, // Map layer mainly

  // Secondary Tech Context
  cloud: { name: 'Cloud Regions', enabled: true, priority: 2 },
  hardware: { name: 'Semiconductors', enabled: true, priority: 2 },
  datacenters: { name: 'Data Centers', enabled: true, priority: 2 },

  // Diagnostics
  monitors: { name: 'System Monitors', enabled: true, priority: 3 },
  'runtime-config': { name: 'Configuration', enabled: true, priority: 3 },
};

// Tech-focused map layers (subset)
// Tech-focused map layers (Infrastructure Only)
export const DEFAULT_MAP_LAYERS: MapLayers = {
  // Core Infrastructure
  cables: true,
  outages: true,
  datacenters: true,
  cyberAttacks: true, // Enable Cyber Attack layer

  // Tech Context
  cloudRegions: true,
  techHQs: true,

  // Disable unrelated layers
  conflicts: false,
  bases: false,
  pipelines: false,
  hotspots: false,
  ...
  displacement: false,
  climate: false,
  startupHubs: false, // User requested removing startup stuff if not infra related? keeping HQs/Clouds
  accelerators: false,
  techEvents: false,
};
