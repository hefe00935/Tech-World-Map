import type { IntelResearchLab } from '@/types';

// Academic research institutions and major strategic labs
// Focused on frontier research and intelligence contributions

export const INTEL_RESEARCH_LABS: IntelResearchLab[] = [
